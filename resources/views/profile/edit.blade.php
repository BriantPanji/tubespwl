<x-layout>
    ...
    <section class="w-full min-h-2 h-24 md:h-30 px-3 pb-2 bg-sl-tertiary rounded-md flex flex-col gap-1 justify-center items-center">
    ...
    <section class="min-w-full max-w-full w-full min-h-2 h-auto bg-sl-tertiary rounded-md px-3 pt-3 pb-3 flex flex-col gap-3 border-2 border-sl-tertiary">
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="w-full h-auto flex flex-col gap-3">
    ...
    <section class="min-w-full max-w-full w-full min-h-2 h-auto bg-sl-tertiary rounded-md px-3 pt-3 pb-3 flex flex-col gap-2 border-2 border-sl-tertiary">

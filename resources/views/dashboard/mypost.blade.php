<x-layout>
    ...
    <div class="container bg-[#32283A] rounded-md max-w-full h-auto ">
            ...
            <div class="container flex justify-start items-center gap-2 px-2 py-1">
                ...
                <div class="container flex justify-center items-center gap-2">
                    <div data-svg-wrapper data-layer="ic:round-arrow-back" class="IcRoundArrowBack relative"><i
                            class="fa-light fa-photo-film-music xl:text-xl"></i></div>
        ...
        <div class="container inline-flex flex-col justify-start items-center gap-4 py-4">
            <h1 class="text-center justify-start text-white text-xs font-light leading-5 px-2 xl:text-base ">Postingan anda
                bersifat rahasia dan hanya tersedia untuk Anda.</h1>
                ...
                <div class="container inline-flex justify-center items-center gap-1 flex-wrap content-start">
                    @forelse($myposts as $post)
                        <img class="size-27 rounded-md xl:size-40"
                             ...
                             alt="Bookmark Image" />
                    @empty
                        <p class="text-center justify-start text-white text-xs font-light leading-5 px-2 xl:text-base italic">Belum ada postingan yang dibuat.</p>
                    @endforelse
                </div>
        </div>
    </div>

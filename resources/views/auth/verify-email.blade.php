<x-authlayout>
    ...
    <div class="flex justify-center items-center h-[100vh] flex-col">
        ...
        <div class="bg-sl-tertiary p-4 rounded-md mt-4 max-w-[400px] xl:max-w-[600px]">
            ...
            <p>Pendaftaran Anda telah diterima, tetapi untuk keamanan, tolong cek email Anda untuk melakukan verifikasi.
                Belum mendapatkan email verifikasi? Klik tombol dibawah ini</p>

            <div class="flex justify-between items-end">
                <form method="POST" action="{{ route('verification.send') }}">
                    @csrf
                    <button type="submit" class="mt-4 bg-sl-base rounded-md py-2 px-4">Kirim Ulang Link
                        Verifikasi</button>
                </form>
